...
​​<img width="2560" height="1389" alt="image (6)" src="https://github.com/user-attachments/assets/20e859d7-1851-46bb-aaa4-9238fbf8bfcb" />
#### (2）可视化编⁡辑
生成的应用将实时展⁠示，可以进入编辑模式，‌自由选择网页元素并且和‌ AI 对话来快速修改‎页面，直到满意为止。
<img width="2560" height="1389" alt="image (7)" src="https://github.com/user-attachments/assets/f49851a8-eaff-42bb-8532-1ba48bdb53f3" />
#### (3）一键部⁡署分享
...
(3)去各大公司充值专门的API资源包。
### 2.谷歌AIStudio进不去?
(1)用github比较火的ClashVerge(95.2kStar),主要是便宜才20多块钱一个月
